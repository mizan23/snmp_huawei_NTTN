Perfect — below is a SINGLE, COMPLETE, FINAL DOCUMENT you can upload directly to GitHub as README.md.
...
full alarm lifecycle function

FULL pysnmp_trap_receiver.py (final, fixed)

FULL cli_user.py (final, decoded, active/history)

usage instructions from zero to working system

No missing parts. No placeholders. No “assume this exists”.
...
Separation of Active alarms and Historical (Recovered) alarms

Operator-friendly CLI viewer

Grafana-ready schema

This design follows how real NMS systems work internally.
...
3.1 Create Database & User (run as postgres)
...
✔ Recovery moves alarms to history
✔ CLI human-readable
✔ Hex decoded Huawei alarms
✔ GitHub-ready
